...
class ModelFitting(QtGui.QDialog):    
    ...
    def createFormGroupBox(self):
        ...
        layout.addRow(QtGui.QLabel("e.d.f. Mu: "), self.Mu_textfield)
        self.Sigma_textfield = QtGui.QLineEdit()
        self.Sigma_textfield.setText("0")
        layout.addRow(QtGui.QLabel("e.d.f. Sigma: "), self.Sigma_textfield)
        self.Lambda_textfield = QtGui.QLineEdit()
        self.Lambda_textfield.setText("0")
        layout.addRow(QtGui.QLabel("e.d.f. Lambda: "), self.Lambda_textfield)
